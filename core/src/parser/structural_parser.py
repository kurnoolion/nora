        ...
        for block in doc.content_blocks:
            ...
            if block.type in (BlockType.PARAGRAPH, BlockType.HEADING):
                ...
                if new_depth is not None:
                    ...
                    # headings (the latter's id never matches requirement_type_pattern).
                    # The priority marker sits BEFORE "ID:" ("... (Priority) ID: <id>"),
                    # so this trailing strip never touches it.
