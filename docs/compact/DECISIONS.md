...
## D-210: Bubble anchors are the row's own req_id set, matched verbatim — never a req-ID regex
...
## D-211: Bubble text comes from the parse tree, not from RAG chunk text
**Status**: Active · **Date**: 2026-09-01.
...
## D-212: Linkification runs after markdown on text nodes only; the req endpoint joins the team gate
**Status**: Active · **Date**: 2026-09-01.
...
## D-213: Hand-injected HTML must be handed to `htmx.process`; the convention is the fix, not the two call sites
**Status**: Active · **Date**: 2026-09-01.
...
## D-235: The "don't think" wire form is declared per roster entry
...
_Promoted from strand: reasoning-wire on 2026-09-16._

## D-236: The Ask page keeps two states; only the wire form varies
**Status**: Active · **Date**: 2026-09-16.
...
## D-237: `chat_template_kwargs` is only ever emitted to suppress thinking
**Status**: Active · **Date**: 2026-09-16.
...
## D-238: The refusal fallback resolves its own mechanism, never the primary's
**Status**: Active · **Date**: 2026-09-16.
...
## D-239: `supports_reasoning_control` stays; an unset mechanism means `reasoning_effort`
**Status**: Active · **Date**: 2026-09-16.
...
endpoints; that is acceptable because the only committed roster was fictional
(`dgx.internal.example`; since removed from this repo — the roster example now
lives in the internal repo), and a real deployment fixes itself by naming the
mechanism.
...
## D-240: Extend the existing history store; dedupe and cap at DISPLAY time only
**Status**: Active · **Date**: 2026-09-16.
...
_Promoted from strand: ask-rerun on 2026-09-16._

## D-241: Record the question at SUBMIT time, not when an answer arrives
**Status**: Active · **Date**: 2026-09-16.
...
## D-242: Re-run uses the CURRENT form settings, not the original ask's
**Status**: Active · **Date**: 2026-09-16.
...
## D-243: Re-run goes through `form.requestSubmit()`, not a parallel ask path
**Status**: Active · **Date**: 2026-09-16.
...
## D-244: History→Ask handoff via localStorage, not a `?q=` query param
**Status**: Active · **Date**: 2026-09-16.
...
## D-245: Share copies without a dialog, from one implementation
**Status**: Active · **Date**: 2026-09-16.
...
## D-246: Test isolation for `NORA_LLM_CONFIG` via an autouse fixture
**Status**: Active · **Date**: 2026-09-16.
...
defect already on `main`, so it rode this branch rather than belonging to it —
called out at merge time.

_Promoted from strand: ask-rerun on 2026-09-16._

## D-247: The deployed roster file lives under `WEB_STATE_DIR`, not `env_dir`
**Status**: Active · **Date**: 2026-09-16.
